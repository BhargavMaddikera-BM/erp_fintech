...
public class InvoiceFilterRequest extends BaseRequest {
	...
	public String toString() {
		return "InvoiceFilterRequest [orgId=" + orgId + ", isInvoiceWithBills=" + isInvoiceWithBills + ", status="
				+ status + ", vendorId=" + vendorId + ", fromAmount=" + fromAmount + ", toAmount=" + toAmount
				+ ", startDate=" + startDate + ", endDate=" + endDate + ", roleName=" + roleName
				+ ", dueAmountGreaterZero=" + dueAmountGreaterZero + ", currencyId=" + currencyId + "]";
	}
