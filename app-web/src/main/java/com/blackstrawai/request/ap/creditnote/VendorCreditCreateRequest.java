...
public class VendorCreditCreateRequest {
	...
	private VendorCreditGeneralInformation generalInfo;
	private VendorCreditTransaction transactionDetails;
	...
	public VendorCreditGeneralInformation getGeneralInfo() {
		return generalInfo;
	}

	public void setGeneralInfo(VendorCreditGeneralInformation generalInfo) {
		this.generalInfo = generalInfo;
	}

	public VendorCreditTransaction getTransactionDetails() {
		return transactionDetails;
	}

	public void setTransactionDetails(VendorCreditTransaction transactionDetails) {
