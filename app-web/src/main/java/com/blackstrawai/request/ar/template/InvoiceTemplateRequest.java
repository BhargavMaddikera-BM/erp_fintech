...
public class InvoiceTemplateRequest extends BaseRequest {
	...
	private InvoiceTemplateInfoRequest templateInformation;	
	...
	public InvoiceTemplateInfoRequest getTemplateInformation() {
		return templateInformation;
	}

	public void setTemplateInformation(InvoiceTemplateInfoRequest templateInformation) {
	...
	public String toString() {
		return "ARInvoiceTemplateRequest [templateId=" + templateId + ", orgId=" + orgId + ", isSuperAdmin="
