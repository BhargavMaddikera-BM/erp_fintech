...
public class OrganizationPartnershipOtherDetailsRequest extends BaseRequest{
	...
	private String partnershipRegistrationNo;
	public int getId() {
		return id;
	}
	...
	public String getPartnershipRegistrationNo() {
		return partnershipRegistrationNo;
	}
	public void setPartnershipRegistrationNo(String partnershipRegistrationNo) {
		this.partnershipRegistrationNo = partnershipRegistrationNo;
	}
