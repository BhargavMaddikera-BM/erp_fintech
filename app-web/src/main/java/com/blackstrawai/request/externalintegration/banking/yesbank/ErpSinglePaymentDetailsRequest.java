...
public class ErpSinglePaymentDetailsRequest {
	...
	public Boolean getIsErpPayment() {
		return isErpPayment;
	}
	public void setIsErpPayment(Boolean isErpPayment) {
		this.isErpPayment = isErpPayment;
	}
	...
	public Integer getPaymentRefId() {
		return paymentRefId;
	}
	public void setPaymentRefId(Integer paymentRefId) {
