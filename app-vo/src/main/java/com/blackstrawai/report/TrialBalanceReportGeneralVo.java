...
public class TrialBalanceReportGeneralVo {
	...
	public String toString() {
		return "TrialBalanceGeneralVo [level2Name=" + level2Name + ", level3Name=" + level3Name + ", level4Name="
				+ level4Name + ", level5Name=" + level5Name + ", journalBookName=" + journalBookName
