...
public class PoTaxDetailsVo {

	private Integer id;
	private String componentName;
	private Integer componentItemId;
	private String groupName;
	private List<PoTaxDistributionVo> taxDistribution;
	...
	public List<PoTaxDistributionVo> getTaxDistribution() {
		return taxDistribution;
	}
	public void setTaxDistribution(List<PoTaxDistributionVo> taxDistribution) {
		this.taxDistribution = taxDistribution;
	}
	@Override
	public String toString() {
		StringBuilder builder = new StringBuilder();
		builder.append("PoTaxDetailsVo [id=");
		builder.append(id);
