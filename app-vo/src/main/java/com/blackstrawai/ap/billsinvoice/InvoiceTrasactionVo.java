...
public class InvoiceTrasactionVo {
	...
	public String toString() {
		...
		builder.append("InvoiceTrasactionVo [sourceOfSupplyId=");
		builder.append(sourceOfSupplyId);
		builder.append(", destinationOfSupplyId=");
		builder.append(destinationOfSupplyId);
		...
		builder.append(discountAmount);
		builder.append(", discountAccountId=");
		builder.append(discountAccountId);
		builder.append(", discountAccountName=");
		builder.append(discountAccountName);
		builder.append(", discountAccountLevel=");
		builder.append(discountAccountLevel);
		...
		builder.append(adjustment);
		builder.append(", adjustmentAccountId=");
		builder.append(adjustmentAccountId);
		builder.append(", adjustmentAccountName=");
		builder.append(adjustmentAccountName);
		builder.append(", adjustmentAccountLevel=");
		builder.append(adjustmentAccountLevel);
