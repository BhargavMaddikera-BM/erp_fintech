...
public class VendorCreditGeneralInformationVo {
	...
	private VendorCreditAddressVo address;
	...
	public VendorCreditAddressVo getAddress() {
		return address;
	}

	public void setAddress(VendorCreditAddressVo address) {
