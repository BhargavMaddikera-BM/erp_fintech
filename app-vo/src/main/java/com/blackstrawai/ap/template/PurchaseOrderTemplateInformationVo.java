...
public class PurchaseOrderTemplateInformationVo {
	...
	private String type="Purchase Order";
	...
	public String toString() {
		return "APPurchaseOrderTemplateinformationVo [id=" + id + ", logoPosition=" + logoPosition + ", headerNotes="
				+ headerNotes + ", footerSectionNotes=" + footerSectionNotes + ", termsAndContd=" + termsAndContd
				+ ", bankAccInfo=" + bankAccInfo + ", footNotes=" + footNotes + ", footNotePosition=" + footNotePosition
				+ ", isAnnex=" + isAnnex + ", userId=" + userId + ", organizationId=" + organizationId + ", roleName="
				+ roleName + ", updateUserId=" + updateUserId + ", updateRoleName=" + updateRoleName + ", status="
