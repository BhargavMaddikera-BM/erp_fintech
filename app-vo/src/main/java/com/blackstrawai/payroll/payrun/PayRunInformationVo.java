...
public class PayRunInformationVo {
	...
	public String toString() {
		return "PayRunInformationVo [payRunInfoId=" + payRunInfoId + ", payRunId=" + payRunId + ", employeeId="
				+ employeeId + ", employeeName=" + employeeName + ", earningsBasic=" + earningsBasic + ", earningsHRA="
				+ earningsHRA + ", earningsSpecialAllowance=" + earningsSpecialAllowance + ", earningsOvertime="
				+ earningsOvertime + ", earningsConveyance=" + earningsConveyance + ", earningsFuel=" + earningsFuel
				+ ", earningsTelephone=" + earningsTelephone + ", deductionsIncomeTax=" + deductionsIncomeTax
				+ ", deductionsProfessionalTax=" + deductionsProfessionalTax + ", deductionsPf=" + deductionsPf
				+ ", totalEarnings=" + totalEarnings + ", totalDeductions=" + totalDeductions + ", netPayable="
				+ netPayable + ", status=" + status + ", earningsLeaveEncashment=" + earningsLeaveEncashment
				+ ", earningsBonus=" + earningsBonus + ", earningsTravel=" + earningsTravel
				+ ", deductionsPfEmployeeContribution=" + deductionsPfEmployeeContribution
				+ ", deductionsPfEmployerContribution=" + deductionsPfEmployerContribution
				+ ", deductionsEsiEmployeeContribution=" + deductionsEsiEmployeeContribution
				+ ", deductionsEsiEmployerContribution=" + deductionsEsiEmployerContribution + ", otherColumns="
				+ otherColumns + "]";
	}
