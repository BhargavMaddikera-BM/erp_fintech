...
public class InvoiceTemplateVo extends BaseVo {
	...
	private InvoiceTemplateinformationVo templateInformation;	
	...
	public InvoiceTemplateinformationVo getTemplateInformation() {
		return templateInformation;
	}

	public void setTemplateInformation(InvoiceTemplateinformationVo templateInformation) {
	...
	public String toString() {
		return "ARInvoiceTemplateVo [templateId=" + templateId + ", orgId=" + orgId + ", UserId=" + UserId
