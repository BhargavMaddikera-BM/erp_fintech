...
public class ReceiptVo extends BaseVo {
	...
	private List<VendorCreditNoteDetailsVo> vendorCreditNoteDetailsVos = new ArrayList<>();
	...
	public String toString() {
		return "ReceiptVo [id=" + id + ", bankId=" + bankId + ", bankType=" + bankType + ", receiptType=" + receiptType
				+ ", receiptNo=" + receiptNo + ", receiptNoPrefix=" + receiptNoPrefix + ", receiptNoSuffix="
				+ receiptNoSuffix + ", receiptDate=" + receiptDate + ", customerId=" + customerId + ", vendorId="
				+ vendorId + ", contactId=" + contactId + ", contactType=" + contactType + ", contactName="
				+ contactName + ", exchangeRate=" + exchangeRate + ", currencyId=" + currencyId + ", amount=" + amount
				+ ", total=" + total + ", notes=" + notes + ", organizationId=" + organizationId + ", adjustedAmount="
				+ adjustedAmount + ", differenceAmount=" + differenceAmount + ", recordBillDetails=" + recordBillDetails
				+ ", recordVendorCreditDetails=" + recordVendorCreditDetails + ", itemsToRemove=" + itemsToRemove
				...
				+ vendorReceiptDetails + ", vendorReceiptItemsToRemove=" + vendorReceiptItemsToRemove
				+ ", generalLedgerData=" + generalLedgerData + ", vendorCreditNoteDetailsVos="
				+ vendorCreditNoteDetailsVos + "]";
	}
